...
<main class="main">
    <div class="container">
        <section class="row row--grid">
            ...
            <!-- title -->
            <div class="col-12">
                <div class="alert alert-Berhasil">{{ session('Berhasil') }}</div>
            </div>
            <!-- end title -->
            @endif
            ...
            <div class="col-12 col-lg-5">
                <div class="offer">
                    ...
                    <div class="offer__wrap">
                        <span class="offer__price">{{ intval($car->daily_rate) }} Harga <sub>/ Hari</sub></span>
                        @if ($car->available)
                    ...
                    <ul class="offer__details">
                        <li>
                            ...
                            <span>{{ $car->passenger_capacity }} penumpang</span>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
