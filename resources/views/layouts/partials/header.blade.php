          ...
          <div class="header__menu">
            <ul class="header__nav">
              <li class="header__nav-item">
                <a href="{{ route('home.index') }}" class="header__nav-link">Beranda</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('car.index') }}" class="header__nav-link">Mobil</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('about.show') }}" class="header__nav-link">Tentang Kami</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('contacts.show') }}" class="header__nav-link">Kontak</a>
              </li>
            </ul>
          </div>
          ...
          <div class="header__actions">
            ...
            <div class="header__action">
              <a class="header__action-btn" href="{{ route('car.index') }}">
                <span>Jelajahi mobil rental kami</span>
