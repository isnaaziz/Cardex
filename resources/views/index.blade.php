    ...
    <div class="row">
      <div class="col-12">
        <div class="home__content">
          <h1 class="home__title">Cardex, <br> Rental Mobil</h1>
          <p class="home__text">Rental mobil paling aman dan mudah di Indonesia!</p>

          <form class="home__search" action="{{ route('car.index') }}" method="get">
            <div class="home__group">
              <label for="marque">Merk</label>
              <input type="text" name="brand" id="marque" placeholder="Cari Merk apa?" required>
            </div>
            
            <div class="home__group">
              <label for="model">Model</label>
              <input type="text" name="model" id="model" placeholder="Model mobil?" required>
            </div>

            <div class="home__group">
              <label for="max_daily_rate">Harga Maksimal / Hari</label>
              <input type="text" name="max_daily_rate" id="max_daily_rate" placeholder="Masukkan harga sewa" required>
            </div>
  ...
  <section class="row row--grid">
    ...
    <div class="col-12">
      <div class="main__title">
        <h2>Hanya 4 langkah simpel untuk menyewa mobil</h2>
      </div>
    </div>
    <!-- end title -->
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="step1">
        ...
        <h3 class="step1__title">Buat Profil</h3>
        @auth
          <p class="step1__text">Apakah anda punya akun ? Kunjungi koleksi mobil kami<br><a href="{{ route('car.index') }}">Mobil</a></p>
        @endauth
        @guest
          <p class="step1__text">Untuk menyewa anda harus membuat akun<br><a href="{{ route('register.show') }}">Daftar</a></p>
        @endguest
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="step1">
        ...
        <h3 class="step1__title">Beri tahu kami mobil apa yang anda cari</h3>
        <p class="step1__text">Kami menyediakan berbagai jenis yang siap untuk anda gunakan</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-xl-4">
      <div class="step1">
        ...
        <h3 class="step1__title">Tentukan pilihan anda</h3>
        <p class="step1__text">Tentukan pilihan mobil anda dan langsung ambil</p>
      </div>
    </div>
  </section>
  <!-- end get started -->
